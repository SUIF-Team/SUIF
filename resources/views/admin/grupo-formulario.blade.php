...
@endphp
<section class="admin-sedes" data-admin-grupo-formulario aria-labelledby="admin-grupo-formulario-titulo">
        ...
        <section class="tarjeta tarjeta--amplia admin-sedes-formulario-tarjeta" data-formulario-ajax>
            ...
            <form
                ...
                <div class="campo admin-sedes-campo--completo">
                    <label class="etiqueta" for="sede_id">Sede *</label>
                    <select class="control" id="sede_id" name="sede_id" required aria-describedby="sede-ayuda">
                ...
                <fieldset class="admin-sedes-horario">
                    ...
                    <div class="admin-sedes-formulario-grid">
                        <div class="campo">
                            ...
                            <input class="control" id="hora_inicio" name="hora_inicio" type="time" required value="{{ old('hora_inicio', $grupo['hora_inicio'] ?? '') }}">
                        </div>
                        <div class="campo">
                            <label class="etiqueta" for="fecha_inicio">Fecha de inicio *</label>
                            <input class="control" id="fecha_inicio" name="fecha_inicio" type="date" required value="{{ old('fecha_inicio', $grupo['fecha_inicio'] ?? '') }}">
                        </div>
                        <div class="campo">
                            <label class="etiqueta" for="hora_fin">Hora de fin *</label>
                            <input class="control" id="hora_fin" name="hora_fin" type="time" required value="{{ old('hora_fin', $grupo['hora_fin'] ?? '') }}">
                        </div>
                        <div class="campo">
                            <label class="etiqueta" for="fecha_fin">Fecha de fin *</label>
                            <input class="control" id="fecha_fin" name="fecha_fin" type="date" required value="{{ old('fecha_fin', $grupo['fecha_fin'] ?? '') }}">
                        </div>
                    </div>
                </fieldset>
                ...
                <div class="admin-sedes-formulario-acciones">
                    ...
                    @endif
                    <a class="boton boton--secundario" href="{{ route('admin.grupos.index') }}">Cancelar</a>
