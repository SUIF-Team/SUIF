...
<section class="admin-sedes" aria-labelledby="admin-administradores-titulo">
    <div class="admin-sedes-contenedor">
        <header class="admin-sedes-encabezado">
            ...
            <a class="boton boton--primario" href="{{ route('admin.administradores.create') }}">
        ...
        <section class="tarjeta tarjeta--compacta" aria-label="Filtros de búsqueda">
            <form method="GET" action="{{ route('admin.administradores.index') }}" class="filtros"
                  data-filtros-tabla="admin-administradores-tabla">
                <div class="campo">
                    <label class="etiqueta" for="buscar">Buscar por nombre o CURP</label>
                    <input class="control" id="buscar" name="buscar" type="search" value="{{ $filtros['buscar'] ?? '' }}">
                </div>
                <div class="campo">
                    <label class="etiqueta" for="rol">Tipo</label>
                ...
                <div class="campo">
                    <label class="etiqueta" for="estatus">Estado</label>
                    <select class="control" id="estatus" name="estatus">
                        <option value="">Todos</option>
                ...
                <div class="campo">
                    ...
                    <select class="control" id="orden" name="orden" data-filtro-orden>
                ...
                <div class="admin-sedes-filtros-acciones">
                    ...
                    <a class="boton boton--peligro" href="{{ route('admin.administradores.index') }}" data-filtros-limpiar>Limpiar</a>
                </div>
            </form>
        </section>

        <section class="tabla-contenedor" aria-label="Lista de administradores">
            <div class="tabla-responsive tabla-desplazable">
                <table id="admin-administradores-tabla" class="tabla tabla--centrada admin-sedes-tabla">
                    <thead>
                        <tr>
                            <th>Administrador</th>
                            <th>CURP</th>
                    ...
                    <tbody>
                            ...
                            <tr data-filtro-buscar="{{ $administrador['nombre'].' '.$administrador['curp'] }}"
                                ...
                                <td>
                                    <div class="admin-administradores-acciones">
                                        <a class="boton boton--texto" href="{{ route('admin.administradores.edit', $administrador['id_usuario']) }}">Editar</a>
                        ...
                        <tr data-tabla-vacia @unless($administradores->isEmpty()) hidden @endunless>
                            <td colspan="6" class="vacio" role="status">No se encontraron administradores con los filtros seleccionados.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
