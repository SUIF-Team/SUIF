    ...
    <section id="inicio" class="container-fluid p-0">
        <div class="row g-0 hero-split">
            ...
            <div class="col-lg-6 hero-right">
                <img src="{{ asset('assets/img/logos/unam-logo.png') }}" alt="Escudo UNAM" class="hero-right-bg-logo">
                <img src="{{ asset('assets/img/logos/uif-blanco.png') }}" alt="Unidad de Inteligencia Financiera" class="hero-uif-logo">
            </div>
        </div>
    </section>
