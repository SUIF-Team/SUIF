...
<section class="sede-shell">
    ...
    @if($confirmada)
        ...
        <div class="sede-confirmada">
            ...
            <div class="sede-acciones">
                ...
                <a href="{{ route('participante.dashboard') }}" class="sede-boton">Continuar</a>
            </div>

            @if(config('app.debug'))
                <p class="sede-demo"><a href="{{ route('participante.sede.reiniciar') }}">Elegir otra sede (demo)</a></p>
            @endif
        </div>
    ...
    @else
        ...
        <form method="GET" action="{{ route('participante.sede.index') }}" class="sede-filtro">
            <select name="entidad">
