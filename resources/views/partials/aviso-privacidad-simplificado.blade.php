...
<section class="aviso-simple" aria-labelledby="aviso-simple-titulo">
    ...
    {{-- <p>
        ...
        el listado de personas certificadas de la UIF y se emite CFDI con tus datos fiscales.
    </p>

    <p>
        <strong>Se transfieren</strong> a la Unidad de Inteligencia Financiera de la SHCP, que
        dictamina y expide el certificado; a la institución bancaria para conciliar tu pago; al SAT
        cuando pides factura; y a las autoridades que lo requieran conforme a la ley.
    </p>

    <p>
        <strong>Puedes negarte</strong> a que tu nombre se publique marcando «no» en el formato de
        autorización de publicación, elegir ticket en vez de CFDI, y ejercer tus derechos ARCO ante la
