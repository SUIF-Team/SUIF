 ...
 *
 * Responsabilidad: alta, edición y baja de quienes administran el sistema, desde
...
class AdministradorController extends Controller
{
     ...
     * conserva la que ya tenía: cambiar un apellido no debería obligar a
    ...
    private function validar(Request $request, bool $modoEdicion, ?int $id = null): array
    {
        ...
        /* La CURP se comprueba dos veces a propósito: aquí para que el error
           ...
           servicio, porque PERSONA.PERS_CURP no tiene índice único y dos altas
           simultáneas esquivarían esta validación. */
        $reglaCurp = ['required', 'string', 'size:18', 'regex:/^[A-Za-z0-9]{18}$/'];
