...
class PagoController extends Controller
{
    ...
    public function subirComprobante(Request $request)
    {
        ...
        $request->session()->put('suif.participante.estado.pago_estado', 'revision');

        return redirect()->route('participante.pago.index')
    ...
    public function demo(Request $request, $estadoDemo)
    {
        ...
        $request->session()->put('suif.participante.estado.pago_estado', $estadoDemo);
