 ...
 * AvanceParticipante
 *
 * Responsabilidad: responder en qué punto del trámite va un participante.
 * Consulta la base una sola vez al construirse y es la única fuente de esa
 * verdad: la usan la barra lateral y el panel del participante.
 */
class AvanceParticipante
{
     ...
     * la solicitud, no cuando el participante terminó de capturar.
     */
